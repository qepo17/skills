...
| `end-to-end-development` | Durable single- or multi-repository orchestration with automatic low-risk plan decisions and explicit approval only for high-risk work. |
