...
- Every validation records ID, exact command/cwd, exit code, result, summary, log path, SHA-256 of the exact command, the result tree fingerprint, and `cache_status`.
